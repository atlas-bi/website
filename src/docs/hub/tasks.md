...
First set the output file type and name. The file name can use python type data parameters. See the [parameters](/docs/hub/parameters/) page for more parameter options.
